...
pub trait VFilesystem {
    ...
    fn open(&self, root_dir: RootDir, path: &str) -> FileSystemResult<Box<VFile>> {
    ...
    fn create(&self, root_dir: RootDir, path: &str) -> FileSystemResult<Box<VFile>> {
    ...
    fn append(&self, root_dir: RootDir, path: &str) -> FileSystemResult<Box<VFile>> {
